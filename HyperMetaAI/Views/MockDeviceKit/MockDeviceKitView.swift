...
@MainActor
private struct MockDeviceKitPreview: View {
  @StateObject private var viewModel = MockDeviceKitView.ViewModel(mockDeviceKit: MockDeviceKit.shared)

  var body: some View {
    MockDeviceKitView(viewModel: viewModel)
  }
}

#Preview("Mock Device Kit") {
  MockDeviceKitPreview()
}
