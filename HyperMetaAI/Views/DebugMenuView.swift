...
@MainActor
private struct DebugMenuPreview: View {
  @StateObject private var viewModel = DebugMenuViewModel(mockDeviceKit: MockDeviceKit.shared)

  var body: some View {
    DebugMenuView(debugMenuViewModel: viewModel)
